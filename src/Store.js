...
laptops: [
  ...
  { id: 220, name: "Dell Alienware m15", price: 210000, image: "/laptops/dell_alienware_m15.jpg", description: "Premium gaming laptop with futuristic design" }
    ...
    mobiles: [
      ...
      { id: 4, name: "Samsung Galaxy S23", price: 74999, image: "/images/s23.jpg", description: "Samsung flagship with stunning AMOLED display" },
      { id: 5, name: "OnePlus 11", price: 58999, image: "/images/oneplus11.png", description: "OnePlus 11 with Hasselblad camera and OxygenOS" },
      ...
      { id: 17, name: "OnePlus Nord 3", price: 28999, image: "/images/oneplus-nord3.webp", description: "Affordable OnePlus with great performance" },
      ...
      { id: 20, name: "Infinix Zero Ultra", price: 20999, image: "/images/infinix-zero-ultra.webp", description: "Budget flagship with curved display" }
    ],
  cameras: [
  { id: 301, name: "Canon EOS 1500D", price: 35000, image: "/cameras/canon_eos1500d.webp", description: "DSLR camera with 24.1MP sensor and DIGIC 4+" },
  { id: 302, name: "Nikon D3500", price: 40000, image: "/cameras/nikon_d3500.png", description: "DSLR camera with 24.2MP sensor and great battery life" },
  ...
  { id: 309, name: "GoPro Hero 11", price: 48000, image: "/cameras/gopro_hero11.webp", description: "Action camera with 5.3K video and HyperSmooth" },
...
smartHome: [
  { id: 401, name: "Amazon Echo Dot (5th Gen)", price: 5500, image: "/smarthome/echo_dot5.jpeg", description: "Smart speaker with Alexa voice assistant" },
  ...
  { id: 405, name: "Mi Smart LED Strip", price: 2500, image: "/smarthome/mi_led_strip.webp", description: "Smart RGB light strip with app control" },
  ...
  { id: 408, name: "Amazon Fire TV Stick 4K", price: 4500, image: "/smarthome/fire_tv_stick.avif", description: "Streaming device with Alexa voice remote" },
...
slippers: [
  { id: 801, name: "Men's Flip Flops", price: 400, image: "/footwear/mens_flipflops.jpeg", description: "Casual rubber flip flops for men" },
...
shoes: [
  ...
  { id: 912, name: "Kids LED Shoes", price: 1700, image: "/footwear/kids_led_shoes.webp", description: "Fun LED light-up shoes for kids" }
],
cricket: [
  ...
  { id: 1004, name: "Batting Pads", price: 2200, image: "/sports/batting_pads.webp", description: "Lightweight cricket batting pads" },
  { id: 1005, name: "Cricket Helmet", price: 2500, image: "/sports/cricket_helmet.webp", description: "Protective cricket helmet" },
  ...
  { id: 1008, name: "Cricket Kit Bag", price: 3000, image: "/sports/cricket_kitbag.webp", description: "Spacious cricket kit bag" },
  { id: 1009, name: "Cricket Shoes", price: 2800, image: "/sports/cricket_shoes.png", description: "Studded cricket shoes for better grip" },
  { id: 1010, name: "Cricket Jersey", price: 1200, image: "/sports/cricket_jersey.webp", description: "Lightweight cricket team jersey" },
...
football: [
  ...
  { id: 1102, name: "Football Shoes", price: 2800, image: "/sports/football_shoes.avif", description: "Studded football boots for firm grip" },
  { id: 1103, name: "Goalkeeper Gloves", price: 1500, image: "/sports/goalkeeper_gloves.jpg", description: "High grip goalkeeper gloves" },
  { id: 1104, name: "Football Jersey", price: 1300, image: "/sports/football_jersey.webp", description: "Lightweight breathable football jersey" },
  { id: 1105, name: "Shin Guards", price: 800, image: "/sports/shin_guards.webp", description: "Protective shin guards for players" },
  { id: 1106, name: "Football Socks", price: 400, image: "/sports/football_socks.webp", description: "Comfortable long football socks" },
  { id: 1107, name: "Football Shorts", price: 900, image: "/sports/football_shorts.jpg", description: "Quick-dry football shorts" },
  { id: 1108, name: "Goal Post Set", price: 5000, image: "/sports/goal_post.webp", description: "Portable goal post set for training" },
  ...
  { id: 1111, name: "Football Backpack", price: 1600, image: "/sports/football_bag.jpeg", description: "Spacious football gear backpack" },
...
groceries: [
  ...
  { id: 1202, name: "Wheat Flour (10kg)", price: 480, image: "/groceries/flour.webp", description: "Freshly milled whole wheat flour" },
  ...
  { id: 1205, name: "Sunflower Oil (1L)", price: 160, image: "/groceries/sunflower_oil.webp", description: "Refined sunflower cooking oil" },
  { id: 1206, name: "Mustard Oil (1L)", price: 180, image: "/groceries/mustard_oil.webp", description: "Pure cold-pressed mustard oil" },
  { id: 1207, name: "Tur Dal (1kg)", price: 140, image: "/groceries/tur_dal.webp", description: "Premium quality split pigeon peas" },
  { id: 1208, name: "Chana Dal (1kg)", price: 120, image: "/groceries/chana_dal.webp", description: "Fresh split chickpeas" },
  { id: 1209, name: "Masoor Dal (1kg)", price: 110, image: "/groceries/masoor_dal.webp", description: "High-protein red lentils" },
...
dairy: [
  ...
  { id: 1304, name: "Paneer (200g)", price: 90, image: "/dairy/paneer.webp", description: "Soft and fresh paneer cubes" },
  { id: 1305, name: "Cheese Slices (200g)", price: 120, image: "/dairy/cheese_slices.jpg", description: "Delicious processed cheese slices" },
  { id: 1306, name: "Butter (500g)", price: 250, image: "/dairy/butter.webp", description: "Creamy salted butter" },
