...
//                         {/* Decrement Button */}
//                         <button
//                           className="btn btn-light border rounded-circle quantity-btn"
...
//                         {/* Quantity */}
//                         <span className="fw-bold quantity-text">{item.quantity}</span>
...
function Cart() {
  ...
  return (
    <div className="cart-page">
      ...
      {cartItems.length > 0 ? (
        <div className="row">
          ...
          <div className="col-md-7">
            <div className="d-flex flex-column gap-3">
              {cartItems.map((item) => (
                <div key={item.id} className="cart-card d-flex align-items-center p-3 shadow-sm rounded-3">
                  {item.image && (
          ...
          <div className="col-md-5">
            ...
            <div className="checkout-box mx-auto mb-4">
              ...
              {couponResult.isValid && (
                <p className="text-success">
                  Coupon Discount ({couponResult.discountPercentage}%): - {formatPrice(couponResult.discountAmount)}
                </p>
              )}
              ...
              <div className="mt-4 row g-2">
                ...
                <div className="col-4">
                  <button className="btn btn-secondary w-100" onClick={handleApplyCoupon}>
                    Apply
                  </button>
                </div>
              </div>
                ...
                <>
                  ...
                  {paymentMethod === "qr" && (
                    <div className="qr-code mt-3">
                      ...
                      <div style={{ width: "140px", margin: "0 auto" }}>
                        <QRCode
                          value={`upi://pay?pa=8886760822@ybl&pn=BhushanCart&am=${finalPrice.toFixed(2)}&cu=INR`}
                          size={140}
                        />
                      </div>
                  ...
                  <button className="btn btn-outline-secondary w-100 mt-2" onClick={() => setShowPaymentOptions(false)}>
                    ❌ Cancel
                  </button>
                </>
              )}
      ...
      {cartItems.length > 0 && (
        <div className="mt-3 text-center">
          <button className="btn btn-danger" onClick={() => { dispatch(clearCart()); toast.info("🗑️ Cart cleared!"); }}>
            Clear Cart
          </button>
        </div>
      )}
